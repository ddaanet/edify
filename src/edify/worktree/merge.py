...
from edify.planstate.inference import _parse_lifecycle_status
from edify.worktree.git_ops import _is_branch_merged, wt_path
...
from edify.worktree.resolve import resolve_learnings_md, resolve_session_md
...
def _format_conflict_report(
    ...
    lines.append("")
    if from_main:
        hint = f"edify _worktree merge --from-main {slug}"
    else:
        hint = f"edify _worktree merge {slug}"
