...
- Files modified:
  - src/claudeutils/token_cache.py (added get_default_cache)
  - src/claudeutils/tokens.py (count_tokens_for_files now uses cache with fallback)
  - src/claudeutils/tokens_cli.py (handle_tokens now uses cache with fallback)
