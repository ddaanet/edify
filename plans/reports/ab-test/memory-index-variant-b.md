...
/how to detect trivial messages | filter noise skip short
/how to order feedback extraction | layer feedback filter priority
...
/how to prevent skill steps from being skipped | prose gates no tool call D+B hybrid
...
/how to review delegation scope template | scope IN OUT changed files requirements
...
/how to dispatch corrector from inline skill | standardized template baseline diff recall report
...
/how to make skills discoverable | surface discovery layers agents miss
...
/how to compose agents via skills | frontmatter inject prompt
/how to recall sub-agent memory | bash transport when-resolve
/how to augment agent context | always-inject on-demand two-tier
...
/how to name session tasks | prose keys task naming
...
/how to wrap a discussion session | findings takeaways submit wrap w
...
/how to chain multiple skills together | continuation passing tail calls
/when using hook based parsing

## agents/decisions/workflow-optimization.md

/how to end workflow with handoff and commit | chain handoff tail calls
...
/how to expand outlines into phases | review phases iteratively expansion
