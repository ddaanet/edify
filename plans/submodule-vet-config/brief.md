...
**Problem:** Commit vet check (C-1) covers `agent-core/bin/**`, `agent-core/skills/**/*.sh` — currently hardcoded. No configurable mechanism for submodule-specific review patterns.
...
**Current state:** handoff-cli-tool Cycle 5.3 hardcodes agent-core patterns as interim.
