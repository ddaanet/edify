...
**Soft limit: 80 lines.** When approaching this limit, use `/codify` to consolidate older learnings into permanent documentation (behavioral rules → project-root `CLAUDE.md`, technical details → `agents/decisions/*.md`). Keep the 3-5 most recent learnings for continuity.
