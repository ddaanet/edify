...
| EARLY-MID | Documentation Structure | handoff-task.md, learnings.md, jobs.md, memory index | Informational scaffolding, progressive discovery |
...
**Token budget:** ~15k tokens heuristic (well under 30k threshold). Measured by `plugin/bin/context-budget.py` (not restored in the 2026-08 revival).
