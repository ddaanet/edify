...
**Decision:** Behavioral ("when X, do Y") and procedural ("how to X") entries only — these prescribe action, creating retrieval intention.

**Consequence:** If a learning can't be phrased as a "when" or a "how", it's either a fragment (ambient) or lacks actionable content.
...
**Evidence:** 801 sessions, 22 behavioral-recall invocations in 8/193 post-merge sessions (4.1%). Baseline skill activation ~20%; 4.1% suggests metacognitive triggers have additional activation penalty vs procedural triggers.
