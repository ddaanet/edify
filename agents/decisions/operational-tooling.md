...
**Anti-pattern:** Using `git checkout main -- `.claude/handoff-task.md` to resolve conflicts — discards all branch-side session data (new tasks, metadata) without verification.
